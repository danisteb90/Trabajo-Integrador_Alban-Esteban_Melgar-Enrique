window.addEventListener("load", function () {
	...
	function mostrarDetallesTurno(turno) {
		...
		document.querySelector("#paciente_nombre").textContent =
			turno.paciente.nombre;
		document.querySelector("#paciente_apellido").textContent =
			turno.paciente.apellido;
		document.querySelector("#paciente_dni").textContent = turno.paciente.dni;
		document.querySelector(
			"#paciente_domicilio"
		).textContent = `${turno.paciente.domicilio.calle} ${turno.paciente.domicilio.numero}, ${turno.paciente.domicilio.localidad}, ${turno.paciente.domicilio.provincia}`;

		document.querySelector("#odontologo_nombre").textContent =
			turno.odontologo.nombre;
		document.querySelector("#odontologo_apellido").textContent =
			turno.odontologo.apellido;
		document.querySelector("#odontologo_matricula").textContent =
